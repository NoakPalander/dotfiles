...
(use-package lsp-mode
  ...
  :hook
  ((elixir-mode . lsp)
   (elixir-mode . (lambda () (local-set-key (kbd "C-c b") 'mix-compile)))
   (elixir-mode . (lambda () (local-set-key (kbd "C-c r") 'mix-run)))
   (elixir-mode . (lambda () (local-set-key (kbd "C-c g") 'elixir-format)))
...
(use-package org
  :mode (("\\.org$" . org-mode))
  :ensure t
  :hook ('org-mode-hook . (lambda () (local-set-key (kbd "C-c r") 'org-edit-src-code)))
  :config
